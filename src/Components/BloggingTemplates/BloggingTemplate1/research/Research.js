    ...
    let displayBlogtravel = this.state.research.reverse().map((blog, i) => {
      return (
        <div className={classes.aboutcol1} key={i}>
          <img className={classes.img} src={'data:image/jpg;base64,' + images[i]} />&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    return (
      <div className={classes.rootCont}>
        ...
        <div className={classes.content} style={this.state.showEditor ? { width: "65%" } : { width: "100%" }}>
          ...
          <button onClick={this.AddBlog} style={{ width: '20%', marginLeft: '30%' }} className="btn btn-primary btn-block btn-large" >ADD BLOG</button>
