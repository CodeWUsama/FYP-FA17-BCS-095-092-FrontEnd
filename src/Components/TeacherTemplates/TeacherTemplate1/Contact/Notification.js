            ...
            return ( 
                <div key={i} style={{ display:'flex', flexDirection:'column', justifyContent:'center', width:'100%' ,marginLeft:'10%'}}>  
                    <div style={{display:'flex', justifyContent:'flex-end', marginRight:'10%'}}> 
                        ...
                        <div className={classes.data} style={{ height:'60px',width:'90%', display:'flex' , justifyContent:'space-around', backgroundColor:'#BCD4E6'}}> 
                        
                            <p style={{width:'10%', overflow:'scroll'}}> {blog.name}</p>     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <p style={{width:'10%' , overflow:'scroll'}}>{blog.email}</p>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <p style={{width:'10%' , overflow:'scroll'}}>{blog.message}</p>  
                        </div>
