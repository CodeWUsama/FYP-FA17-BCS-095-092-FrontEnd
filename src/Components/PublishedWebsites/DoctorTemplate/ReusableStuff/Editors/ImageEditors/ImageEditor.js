            ...
            <div>
                <div>
                    ...
                    <div className={classes.upload}>
                        ...
                        <button onClick={(event) => this.props.submitHandler(event,this.state.selectedFile)} type="submit" style={{ width: "150px", marginTop: 50 }} className="btn btn-primary">Update</button>
                    </div>
                </div>
            </div>
        );
