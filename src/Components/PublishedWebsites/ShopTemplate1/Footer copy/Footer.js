                ...
                <div className={classes.rootCont}>
                    ...
                    <div className={classes.div2}>
                        ...
                        <div className={classes.linksCont}>
                            <a href="/ShoppingWebsite/#/" className={classes.links}> Home</a>
                            <a href="/ShoppingWebsite/#/products" className={classes.links}> Products</a>
                            <a href="/ShoppingWebsite/#/contact" className={classes.links}> Contact</a>
                            <a href="/ShoppingWebsite/#/account" className={classes.links}> Login</a>
                        </div>
                    </div>
