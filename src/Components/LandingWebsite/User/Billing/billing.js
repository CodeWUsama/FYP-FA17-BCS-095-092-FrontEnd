...
import AlertDialog from "./../../../ResuableStuff/ConfirmationDialog/dialog";
    ...
    return (
        <div style={{ marginTop: 50 }}>
            <React.Fragment>
                <AlertDialog
                    isOpen={open}
                    handleClose={() => { setOpen(false); window.location.reload() }}
                    handleAgree={handleAgree}
                    title="Cancel Subscription?"
                    description="Are you sure to cancel your monthly subscription from website creator. Upon agree, you subscription will be imediately canceled and you will be moved to Free package."
                />
                        ...
                        {tiers.map((tier) => (
                            ...
                            <Grid item key={tier.title} xs={12} sm={tier.title === 'Enterprise' ? 12 : 6} md={4}>
                                <Card>
                                    ...
                                    <CardActions>
                                        <Button onClick={() => { handleSelection(tier.title) }} disabled={tier.title == currentPlan ? true : false} fullWidth variant={tier.buttonVariant} color="primary">
                                            {tier.title === currentPlan ? "Selected" : tier.buttonText}
                                        </Button>
                                    </CardActions>
                                </Card>
                            </Grid>
