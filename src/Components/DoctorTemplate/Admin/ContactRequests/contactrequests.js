...
const ContactRequest = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            await fetch("http://localhost:8080/d1td/viewMessages?id=" + localStorage.getItem("id"), {
                method: "GET",
                headers: {
    ...
    let handleReply = () => {
        fetch("http://localhost:8080/d1td/reply", {
            method: "POST",
            headers: {
                Authorization: "Bearer " + localStorage.getItem('token'),
                "Content-Type": 'application/json'
    ...
    let handleDelete = (id) => {
        fetch("http://localhost:8080/d1td/deleteMessage", {
            method: "POST",
            headers: {
                Authorization: "Bearer " + localStorage.getItem('token'),
                "Content-Type": 'application/json'
    ...
    return (
        <div className={classes.rootCont}>
            ...
            <div style={{ marginTop: "20px" }} className="container">
                ...
                <p>In this table, contact messages are being displayed:</p>
