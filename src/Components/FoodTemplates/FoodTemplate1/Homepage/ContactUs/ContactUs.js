                ...
                <div className={classes.rightCont}>
                    <div className={classes.picCont}>
                        ...
                        <p
                            ...
                            onClick={this.props.adminNameHandler}
                        >{this.props.adminName.text}</p>
                        <p
                            style={{
                            ...
                            onClick={this.props.adminMessageHandler}
                            className={classes.adminMsg}>{this.props.adminMessage.text}</p>
                    </div>
                </div>
