    ...
    render() {
        ...
        if (this.state.products) {
            ...
            products = array.map((product, i) => {
                return <ProductTemplate id={product._id} img={this.state.imgs[i]} key={i} sizes={product.sizes} colors={product.colors} title={product.name} price={product.price} desc={product.description} flexBasis={this.state.columns} />
            })
        }
